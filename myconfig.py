...
# STEERING_LEFT_PWM = 517          #pwm value for full left steering
# STEERING_RIGHT_PWM = 257        #pwm value for full right steering
# 
...
# THROTTLE_STOPPED_PWM = 140      #pwm value for no movement
# THROTTLE_REVERSE_PWM = 80      #pwm value for max reverse throttle
# 
